...
const About = (props: Props) => {
  ...
  return (
    <div className=' max-sm:flex-col min-h-screen bg-gradient-to-b from-black  via-red-900  to-red-900 
    ' >
     
      <div className='col-start-1 col-span-6 row-start-1 z-[9999] max-sm:z-40' >
      <NavBar/>
      </div>
     ...
     <div className='flex md:space-x-2 flex-col  z-0 md:-mb-12 md:p-4  md:self-center md:justify-self-center  rounded-lg  ' >
     
      <div className=' flex  max-sm:h-[75vh] md:top-4 max-sm:self-start max-sm:justify-center relative md:-top-48 max-sm:-left-2 max-sm:top-32 max-w-[800px]  md:max-h-[500px]  
        1 max-sm:h-full relative md:-top-4  md:self-center z-0 max-sm:px-4 md:pt-0' >
          <About_Modal/>
      </div>
      <div className='flex  flex-col md:relative md:w-4/6 md:self-center z-0 max-sm:justify-end max-sm:z-50 max-sm:self-start mt-14 space-y-6  ' >
      ...
      <div className='flex  rounded-md  text-white' >
       ...
       {/*  <div className='flex flex-col' >
        ...
        <div className='flex flex-col  max-sm:space-y-4 w-4/5 self-center ' >
          <h1 className='font-Gardion relative max-sm:left-6 text-lg' >Meet The Team</h1>
       
          <div className='flex max-sm:flex-col max-sm:self-center max-sm:justify-self-center max-sm:space-y-4' >
                 <Image className='max-sm:relative max-sm:left-0 max-sm:justify-around rounded-md md:w-[17.5vw]  md:h-[45vh] max-sm:w-[90vw] max-sm:h-[60vh] '  quality={100} height={400} width={400} src={JB_Profile_Pic} alt='Julian Borner Profile Pic' />
     ...
     <div className='flex relative max-sm:top-28 top-10 row-start-4 col-start-1 col-span-4 justify-around  ' >
     ...
     <div className='flex relative  max-sm:top-36  top-10 max-sm:top-48    self-center justify-around 
      ' >
     <Footer/>
     </div>
