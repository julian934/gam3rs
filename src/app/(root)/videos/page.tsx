...
const Videos = (props: Props) => {
  ...
  return (
    <div className='flex grid grid-cols-6 grid-rows-2 bg-white ' >
      ...
      <div className='flex border-2 border-black flex-col max-sm:mt-0 md:mt-48 z-50 max-sm:border-2 max-sm:w-full max-sm:px-4 max-sm:border-black justify-start self-start md:self-end -mt-8 max-sm:-mt-48 max-sm:mb-12 col-start-2 max-sm:col-start-1 col-span-4 max-sm:col-span-7 row-start-2 md:row-start-1 row-span-2 max-sm:row-span-3 bg-black rounded-lg' >
