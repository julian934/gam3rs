...
<div className=' relative md:-top-[40vh] md:-left-[2.3vw]  bg-white rotate-45  w-[5vw] h-[10vh] z-[9999]' >
      ...
      <div className=' flex max-sm:invisible max-sm:border-2 max-sm:border-black max-sm:h-full md:relative md:top-20 row-start-1 md:mt-40 row-span-2 md:h-5/6 md:w-2/3 md:px-8 justify-self-end rounded-md self-start md:col-start-4 bg-slate-200 ' >
