...
const News = ({user}:any) => {
  ...
  return (
    <div className='flex  max-sm:w-96 max-sm:max-w-[400px]  md:z-0 max-sm:z-0 max-sm:px-10 max-w-[700px] max-h-[600px]  lg:justify-self-center  max-sm:py-10 grid grid-cols-4 grid-rows-4  bg-black md:w-full md:h-full flex-col rounded-lg md:justify-between' >
