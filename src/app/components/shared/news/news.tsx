...
const News = ({user}:any) => {
  ...
  return (
    <div className='flex  max-sm:border-2 max-sm:border-black  max-sm:py-10 grid grid-cols-4 grid-rows-4 bg-slate-200 md:w-full md:h-1/2 flex-col rounded-lg md:justify-between' >
    {/*  <div className='col-start-1 border-2 border-black md:flex md:space-between -ml-2 -mt-4 row-start-1 inline-block -left-24  mt-20 h-20 w-60 z-60  skew-x-12 bg-white absolute rotate-90  ' >
          ...
          */}
          ...
          <div className='flex  max-sm:w-1/2 max-sm:h-1/2 max-sm:rotate-0 max-sm:h-full max-sm:mt-0 max-sm:-ml-12  col-start-1 row-start-2 w-full h-6  bg-slate-200 -skew-x-12 max-sm:skew-x-0 max-sm:rotate-0  -rotate-90 z-50  -ml-28 mt-14 -mr-2 ' >
             {/* Mid Left Design Upper */}
          </div>
          <div className='flex max-sm:w-full max-sm:h-3/4 max-sm:mt-20 max-sm:-ml-14   col-start-1 row-start-2 w-1/2 h-1/3  bg-slate-200 -skew-x-12 -rotate-90  -ml-14 mt-24 -mt-6  z-50' >
      ...
      <div className='flex max-sm:self-center max-sm:justify-self-start col-start-2 col-span-2 row-start-1 row-span-3 z-10 p-4' >
      ...
      <div className='flex max-sm:h-2/3 max-sm:border-2 max-sm:border-black max-sm:-mt-24 max-sm:-ml-8 self-start pb-4 space-around -mt-16 w-4/5 h-full  col-start-3 row-start-1 col-span-3 justify-self-end bg-white skew-x-12 space-x-4 space-y-8 px-2 ' >
          ...
          <div className='flex max-sm:border-2 max-sm:border-slate-200 w-full h-1/4 bg-slate-200 skew-x-12 self-end' >
