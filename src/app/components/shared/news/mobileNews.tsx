  ...
  return (
    <div className='flex max-sm:relative  max-sm:-top-12 md:max-h-[600px] max-sm:max-h-[250px] max-sm:max-w-[400px]   grid grid-cols-4 grid-rows-4  bg-black md:w-full md:h-1/2 flex-col rounded-lg md:justify-between' >
         ...
         <div className='flex  max-sm:w-full md:w-3/4 md:left-6 md:-top-12 relative max-sm:-left-2 max-sm:h-full max-sm:-mt-24 max-sm:-ml-6  col-start-1 rotate-45 max-sm:-rotate-45 row-start-2 w-1/2   -ml-8 -mt-16  2xl:-mt-80  bg-white ' >
          ...
          <div className='flex max-sm:relative max-sm:-left-12 max-sm:w-full   max-sm:h-1/2 max-sm:mt-0 max-sm:-ml-2  col-start-1 row-start-2 w-1/2 h-1/2 2xl:w-3/4  bg-white -skew-x-12 rotate-90  -ml-6 2xl:-ml-12 mt-16 2xl:mt-12' >
               {/* Mid Left gap upper*/}
          </div>
          ...
          <div className='flex  b max-sm:w-full  max-sm:bg-white max-sm:h-full max-sm:-mt-2 max-sm:-ml-14  col-start-1 row-start-2 w-1/2 h-1/3  bg-black -skew-x-12 -rotate-90  -ml-6 max-sm:mt-24 max-sm:w-2/3 max-sm:h-1/2 mt-24 2xl:mt-28 -mt-6  z-50' >
       ...
       <div className='flex  max-sm:relative max-sm:left-0 max-sm:w-full max-sm:top-10 md:w-full md:col-start-1 md:col-span-4 z-50    max-sm:justify-start self-center col-start-2 col-span-2 row-start-1 md:row-start-2 md:w-full md:justify-center row-span-3 md:-mt-12 z-10 p-4' >
          ...
          <div className='flex max-sm:relative max-sm:top-0 w-full h-1/4 lg:h-2/5  max-sm:h-3/5 bg-black skew-x-12 self-end max-sm:self-end' >

          </div>
          <div className='flex  max-sm:relative max-sm:top-0  w-full h-1/4 lg:h-2/5 max-sm:h-3/5 bg-red-600 skew-x-12 self-end' >

          </div>
          <div className='flex max-sm:relative max-sm:top-0  w-full h-1/4 lg:h-2/5 max-sm:h-3/5  bg-black skew-x-12 self-end' >
      ...
      <div className='flex  max-sm:relative max-sm:left-2 max-sm:top-12   z-50 row-start-1 col-start-4 w-3/4 h-3/4  bg-white rotate-45 ml-32 2xl:ml-32 mt-28 2xl:-mt-2
                      max-sm:-mt-8 max-sm:ml-20 max-sm:w-1/3 max-sm:h-1/2 ' >
        {/* Upper right slant*/}
      </div>
