  ...
  return (
    <div className='flex max-sm:flex-col max-sm:self-center justify-around rounded-md bg-white md:w-full md:h-1/4' >
      <div className='w-[200px] space-y-5 p-4 flex  max-sm:flex-col bg-white md:self-center' >
        <h1 className='flex justify-center text-lg flex rounded-sm  bg-gradient-to-r from-red-900 via-red-500 shadow-xl  hover:scale-110 to-red-900 hover:bg-gradient-to-r hover:from-red-900 hover:via-red-300 hover:to-red-900 -skew-x-12 w-32 text-white ' >Recent Forums</h1>
       </div>
      
      {data? <div className='w-[200px] max-sm:self-center max-sm:w-[300px] space-y-5  p-4  flex  max-sm:flex-col bg-white  md:mb-0 md:justify-self-center md:self-start md:border-black md:flex-row md:w-full md:h-full md:space-x-4' >
