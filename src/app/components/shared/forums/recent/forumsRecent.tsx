...
const Recent = (props: Props) => {
  ...
  return (
    <div className='flex max-sm:flex-col max-sm:self-center justify-around rounded-md bg-white md:w-full md:h-1/4' >
      ...
      {data? <div className='w-[200px] max-sm:self-center max-sm:w-[350px] space-y-5  p-4  flex  max-sm:flex-col bg-white  md:mb-0 md:justify-self-center md:self-start md:border-black md:flex-row md:w-full md:h-full md:space-x-4' >
