...
const Popular = (props: Props) => {
  ...
  return (
    ...
    {data? <div className='w-[200px] space-y-5 max-sm:self-center max-sm:w-[300px]  p-4  flex  max-sm:flex-col bg-white  md:mb-0 md:justify-self-center md:self-start md:border-black md:flex-row md:w-full md:h-full md:space-x-4' >
