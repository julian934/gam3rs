    ...
    <div className='flex  max-sm:border-2 max-sm:border-black  max-sm:py-10  grid grid-cols-4 grid-rows-4  bg-black md:w-full md:h-1/2 flex-col rounded-lg md:justify-between' >
       ...
       <div className='flex md:w-full md:col-start-1 md:col-span-4 z-50    max-sm:justify-start self-center col-start-2 col-span-2 row-start-1 md:row-start-2 md:w-full md:justify-center row-span-3 md:-mt-12 z-10 p-4' >
            <div className='flex flex-col w-full self-start self-center   justify-center md:items-center  ' >
             <h1 className='text-white self-center  justify-self-center text-7xl ' >GAM<span className='text-red-500' >3RS</span></h1>
          ...
          <div className='flex  w-full h-1/4 max-sm:h-full  bg-black skew-x-12 self-end' >

          </div>
          <div className='flex mw-full h-1/4 bg-white skew-x-12 self-end' >
      ...
      <div className=' max-sm:flex   max-sm:ml-0 max-sm:-mb-12 col-start-1 col-span-2 justify-center space-x-2 space-between bg-white flex self-end ml-12 w-48 h-8 row-start-4 skew-x-12 ' >
        <div className=' w-10 bg-black h-4 skew-x-12  self-end max-sm:self-center ' >
            {/* Bottom Left design */}
        </div>
        <div className='w-10  bg-red-600  h-4 skew-x-12 self-end max-sm:self-center ' >
      ...
      <div className='flex  z-50 row-start-1 col-start-4 w-3/4 h-3/4  bg-white rotate-45 ml-32 mt-28 
