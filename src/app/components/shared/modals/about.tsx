...
const About_Modal = ({user}:any) => {
  ...
  return (
    <div className='flex max-sm:relative max-sm:-right-2  max-sm:py-10  grid grid-cols-4 grid-rows-4  bg-black md:w-full md:h-1/2 flex-col rounded-lg md:justify-between' >
         <div className='flex max-sm:w-full  max-sm:relative max-sm:-left-2 max-sm:h-full max-sm:-mt-24 max-sm:-ml-6   col-start-1 rotate-45 max-sm:-rotate-45 row-start-2 w-1/2   -ml-8 -mt-16  2xl:-mt-80  bg-white ' >
            {/* Upper left slant */}
          </div>
       ...
       <div className='flex  max-sm:relative max-sm:-left-14 md:w-full md:col-start-1 md:col-span-4 z-50    max-sm:justify-start self-center col-start-2 col-span-2 row-start-1 md:row-start-2 md:w-full md:justify-center row-span-3 md:-mt-12 z-10 p-4' >
            ...
            <div className='flex relative max-sm:top-0  max-sm:h-4/5 max-sm:w-4/5  md:z-50 max-sm:-mt-44 max-sm:-mr-4 2xl:mr-12 self-center pb-2 space-around -mt-16 2xl:-mt-80 w-3/5 max-sm:w-full h-4/5  col-start-3 row-start-2 col-span-3 justify-self-end bg-white skew-x-12 space-x-4 space-y-8 px-2  z-50 ' >
