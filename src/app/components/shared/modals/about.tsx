  ...
  return (
    <div className='flex max-sm:relative max-sm:-right-2 md:max-h-[600px] max-sm:max-h-[250px]  max-sm:py-10  grid grid-cols-4 grid-rows-4  bg-black md:w-full md:h-1/2 flex-col rounded-lg md:justify-between' >
      {session && <div className='max-sm:invisible md:visible md:bg-white  md:w-full md:h-[50px] md:absolute md:mt-0 md:z-[9999]   '  >   </div>}
         <div className='flex max-sm:w-full md:w-4/5 md:left-4 md:-top-8 relative max-sm:-left-2 max-sm:h-full max-sm:-mt-24 max-sm:-ml-6  col-start-1 rotate-45 max-sm:-rotate-45 row-start-2 w-1/2   -ml-8 -mt-16  2xl:-mt-80  bg-white ' >
            {/* Upper left slant */}
          </div>
          ...
          <div className='bg-white absolute   w-[50vw]  h-[20vh]  ' >
                {/* Top white area */}
          </div>
       <div className='flex  max-sm:relative max-sm:-left-14 md:w-full md:col-start-1 md:col-span-4 z-50    max-sm:justify-start self-center col-start-2 col-span-2 row-start-1 md:row-start-2 md:w-full md:justify-center row-span-3 md:-mt-12 z-10 p-4' >
            ...
            <div className='flex relative max-sm:top-0 md:z-[9999]  md:-top-4 md:left-2   max-sm:h-4/5 max-sm:w-4/5  md:z-50 max-sm:-mt-44 max-sm:-mr-4 2xl:mr-12 self-center pb-2 space-around -mt-16 2xl:-mt-80 w-3/5 max-sm:w-full h-3/5  col-start-3 row-start-2 col-span-3 justify-self-end bg-white skew-x-12 space-x-4 space-y-8 px-2  z-50 ' >
      ...
      <div className='flex relative md:-left-8 max-sm:-left-2 max-sm:top-2  z-[9997] row-start-1 col-start-4 w-3/4 h-3/4  bg-white rotate-45 ml-32 2xl:ml-32 mt-28 2xl:-mt-2
                      max-sm:-mt-8 max-sm:ml-20 max-sm:w-1/2  ' >
        {/* Upper right slant*/}
      </div>
      <div className='flex  max-sm:mt-10 max-sm:ml-12 relative md:top-6 md:-left-6  max-sm:w-full max-sm:h-2/3 z-60 max-sm:z-50 row-start-3 col-start-4 w-1/2 h-1/2 -rotate-90 bg-white  skew-x-12 ml-32 mt-20 ' >
        {/* Mid-right slant*/}
      </div>
      <div className='flex max-sm:mt-18 max-sm:ml-10  relative md:top-2 md:left-2 max-sm:h-full max-sm:w-full   z-60 row-start-4 col-start-4 w-full h-full bg-white  -rotate-45 ml-14 mt-12 ' >
        {/* Bottom Right */}
