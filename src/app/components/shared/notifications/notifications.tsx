  ...
  return (
    <div className='flex space-y-8 max-h-[45vh]  flex-col rounded-md z-[9999] max-sm:z-30 w-full max-sm:h-40 md:mt-0 max-sm:py-4 ' >
     ...
     bg-gradient-to-r from-red-900 via-red-500 shadow-xl  hover:scale-110 to-red-900 hover:bg-gradient-to-r hover:from-red-900
      ...
      <div className='flex font-Gardion relative z-[9999]   max-sm:w-48 md:w-56 max-sm:text-xl h-8 max-sm:ml-4 md:-right-2  justify-center text-3xl md:text-lg  bg-white' >
      ...
      <Link className='flex flex-col rounded-md  max-h-[100vh]  space-y-2 pb-4' href={`/videos/${vals?.playbackId}`} key={vals?.playbackId}  >
        <h1 className='w-full relative left-6 top-2 text-sm text-red-900 z-[9999] ' >{vals?.user}  </h1>
        ...
        <div className='absolute min-w-[22.5vw]   h-full bg-black scale-80   ' >
          <div className='absolute bg-red-600 w-14 h-[1.5vh]  top-[0.5vh] left-56  skew-x-[0.85rad]  z-[9999]' >
            {/* Top Right Red */}
            </div>
          <div className='absolute bg-white w-24 h-6  -top-2 left-52  skew-x-[0.9rad] rounded-sm ' >

          </div>
          <div className='absolute  bg-white w-4 h-12 -left-2 -top-6 rotate-45 ' >
            {/* Top Left */}
          </div>
           <div className='absolute  bg-white w-4 h-12 left-72  -top-2 -rotate-45 ' >
            {/* Top Right */}
          </div>
           <div className='absolute bg-white w-4 h-12 -left-2 top-20 -rotate-45'>
            {/* Bottom Left */}
          </div>
           <div className='absolute  bg-white w-20 h-20 left-64 top-24  rotate-45 ' >
            {/* Bottom Right */}
          </div>
           ...
           <h1 className=' px-2 relative text-red-900 z-[9999] ' >{vals.user} just posted to </h1>
           <h1 className='flex text-red-900 relative z-[9999] px-2  max-sm:w-48 md:w-72 max-sm:text-xl h-8 max-sm:ml-4 md:-right-2  text-2xl w-64 text-white' >
            {vals.forumName}
           </h1>
          <div className='absolute min-w-[22.5vw] top-2  h-full bg-black    ' >
          <div className='absolute bg-red-600 w-14 h-[1.5vh]  top-[0.5vh] left-56  skew-x-[0.85rad]  z-[9999]' >
            {/* Top Right Red */}
            </div>
          <div className='absolute bg-white w-24 h-6  -top-2 left-52  skew-x-[0.9rad] rounded-sm ' >
