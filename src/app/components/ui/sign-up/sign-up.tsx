...
export function SignupForm() {
  ...
  return (
    <div className="max-w-md w-full mx-auto rounded-none md:rounded-2xl p-4 md:p-8 shadow-input bg-white dark:bg-black z-0 ">
      <h2 className="font-bold text-xl text-neutral-800 dark:text-neutral-200 z-50 ">
        Welcome to The Gam3r Network
      </h2>
      <p className="text-neutral-600 text-sm max-w-sm mt-2 dark:text-neutral-300">
        Sign up, and if you have an account <Link href='/signin' > Sign In Here</Link>.
      </p>
      ...
      <form className="my-8" onSubmit={handleSubmit}>
        ...
        <LabelInputContainer className="mb-4">
          ...
          <Input  onChange={handleUser} ref={username}  id="email" placeholder="projectmayhem@fc.com" type="email" />
        </LabelInputContainer>
        <LabelInputContainer className="mb-4">
          <Label htmlFor="password">Password</Label>
          <Input  onChange={handlePass}  ref={password} id="password" placeholder="••••••••" type="password" />
        </LabelInputContainer>
