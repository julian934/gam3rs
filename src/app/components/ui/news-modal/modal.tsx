...
export function InfiniteMovingCardsDemo() {
  ...
  return (
    <div className="h-[20rem] md:h-2/3 border-2 flex md:self-center border-black rounded-md flex antialiased bg-white dark:bg-black dark:bg-grid-white/[0.05] items-center justify-center relative overflow-hidden">
        <div className="flex " >
        <InfiniteMovingCards
        items={newsState}
        direction="right"
