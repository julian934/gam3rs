...
const AboutJulian = (props: Props) => {
  ...
  return (
    <div>
        ...
        <div className='flex max-sm:relative max-sm:left-8 h-[6vh] max-sm:w-[80vw] md:w-[30vw]  relative left-56 justify-center text-lg flex rounded-sm md:self-center bg-gradient-to-r from-red-900 via-red-500 shadow-xl   to-red-900  -skew-x-12 w-40  text-white' >
...
<div className='absolute w-10 h-10 max-sm:-top-[2.95vh] max-sm:left-[84.8vw] md:-left-6 bg-white md:top-[17vh] rotate-45 ' >
